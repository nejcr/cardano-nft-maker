...
export const MintTokenForm = (props: MintTokenFormProps) => {
    ...
    return <Box px={{base: '4', md: '10'}} py="16" maxWidth="3xl" mx="auto">
        <MintTokenConformationForm submissionData={formConfirmationState} isOpen={formConfirmationOpened}
        ...
        >
            ...
            {({handleSubmit, values, errors}) => {
                const uniquenessError = (errors?.hasOwnProperty("metadata") && !Array.isArray(errors.metadata))
                return (
                        ...
                        <Stack spacing="4" divider={<StackDivider/>}>
                                                    ...
                                                    values.metadata.map((field, index) => (
                                                        <div key={index}>
                                                            <HStack alignItems={"end"}>
                                                                <InputControl name={`metadata.${index}.key`}
                                                                              height={"110px"}
                                                                              label="Key"/>
                                                                <InputControl name={`metadata.${index}.value`}
                                                                              height={"110px"}
                                                                              label="Value"/>
                                                            ...
                                                            <>
                                                                {uniquenessError ? <Box textAlign={"right"}
                                                                                        color={"red.300"}>{errors?.metadata}</Box> :
                            ...
                            <FieldGroup title="Asset">
                                <Stack direction="row" spacing="6" align="center" width="full"
                                    ...
                                    <Tooltip padding={0} label={<Image objectFit="cover" boxSize="300px"
                                                                       src={fileSrc}/>}
                                             fontSize="md" placement={"top-end"}>
                                        <Avatar
                                            size="xl"
                                            name="Alyssa Mall"
                                            src={fileSrc}
                                    ...
                                    <Box>
                                        ...
                                        <Text fontSize="sm" mt="1" textAlign={"right"} mr={3}
                            ...
                            <FieldGroup mt="8">
                                <HStack width="full" justifyContent={"flex-end"}>
                                    ...
                                    <Button variant="outline"
                                            onClick={props.onClose as MouseEventHandler}>Cancel</Button>
                                </HStack>
                            </FieldGroup>
